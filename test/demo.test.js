...
const test = ({ JSONClass, JSONClassError, Suite, CommonSuite, chai, mode }) => {
  let scope = 'demo';
  let demo = new Suite(scope, `Demo Test Suite [${mode}] - just copied from src/jsonclass.js to check the initial test configurations`);

  demo.test = class DemoTest extends CommonSuite {
